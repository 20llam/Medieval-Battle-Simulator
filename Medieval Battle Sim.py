...
def Battle(enemyName,enemyStrength,enemySpeed,enemyMagic):
        enemy = Character()
        enemy.stats.SetStrength(20)
        enemy.stats.SetSpeed(20)
        enemy.stats.SetMagic(10)
